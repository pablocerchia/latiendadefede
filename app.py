...
df = pd.read_csv(r'C:\Users\user\Downloads\ST-Fravega-app\data\st_tabla_totalesycantidad.csv')
df_articulos = pd.read_csv(r'C:\Users\user\Downloads\ST-Fravega-app\data\df_articulos_ST.csv')
df_rubros = pd.read_csv(r'C:\Users\user\Downloads\ST-Fravega-app\data\df_rubros_ST.csv')
metodos = pd.read_csv(r'C:\Users\user\Downloads\ST-Fravega-app\data\metodospago.csv')
